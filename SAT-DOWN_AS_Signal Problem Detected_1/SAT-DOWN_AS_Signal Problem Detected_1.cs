...
namespace Signal_Problem_Detected_1
{
    ...
    public class Script
    {
        public void Run(Engine engine)
        {
            ...
            if (trigger[3] == "MAIN")
            {
                TriggerMain(engine, trigger);
            }
            else
            {
                TriggerBackup(engine, trigger);
            }
        }

        private static void TriggerBackup(Engine engine, string[] trigger)
        {
            string setParam = "";
            int setVal = 0;
            UIResults uir = null;
        ...
        private static void TriggerMain(Engine engine, string[] trigger)
        {
            string setParam = "";
            int setVal = 0;
            UIResults uir = null;
